...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= BASE_THEME ?>adm/app-assets/css/pages/error.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
...
<body class="vertical-layout vertical-menu 1-column  bg-gradient-directional-danger menu-expanded blank-page blank-page" data-open="click" data-menu="vertical-menu" data-color="bg-gradient-x-purple-blue" data-col="1-column">
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="col-md-4 col-10 p-0">
                            <div class="card-header bg-transparent border-0">
                                ...
                                <h3 class="text-uppercase text-center white">Anda tidak memiliki akses pada halaman ini !</h3>
                            </div>
                            <div class="card-content">
                                ...
                                <div class="row py-2 text-center">
                                    <div class="col-12">
                                        <a href="<?= BASE_URL ?>" class="btn btn-white danger box-shadow-4"><i class="ft-home"></i> Kembali ke Beranda</a>
                                    </div>
                            ...
                            <div class="card-footer bg-transparent">
                                <div class="row">
                                    <p class="text-muted text-center col-12 py-1 white">Copyright &copy; <strong>SIPEKA </strong> <?= date('Y') ?> | Dikembangkan oleh <strong><a href="#" style="color: #ffffff;">Yasinta Surya Maharani</a></strong> </p>
    ...
    <script src="<?= BASE_THEME ?>adm/app-assets/vendors/js/forms/validation/jqBootstrapValidation.js" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN CHAMELEON  JS-->
    ...
    <!-- END CHAMELEON  JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="<?= BASE_THEME ?>adm/app-assets/js/scripts/forms/form-login-register.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
</body>

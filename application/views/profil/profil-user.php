                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body" style="font-family: Calibri !important; font-size: 1.3em;">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control" for="nama-kadin"><?= $role == 'Pusat' ? 'Nama Sub Koordinator ' : 'Nama Kepala Dinas' ?></label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row" id="elevasi">
                                        <label class="col-md-3 label-control" for="jabatan-kadin"><?= $role == 'Pusat' ? 'Jabatan ' : 'Jabatan Kepala Dinas' ?></label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control" for="doc-ttd"><?php echo $role == 'Pusat' ? 'Tanda Tangan Sub Koordinator' : 'Tanda Tangan Kepala Dinas' ?></label>
                                        <div class="col-md-9">
                ...
                <div class="bug-list-sidebar-content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body border-top-blue-grey border-top-lighten-5 text-center" style="font-family: Calibri !important;">
                            ...
                            <p class="blue-grey text-uppercase font-small-2 mb-0">( <?= $role == 'Pusat' ? 'SUB KOORDINATOR' : 'KEPALA DINAS' ?> )</p>
                        </div>
                    </div>
                    <!--/ Predefined Views -->

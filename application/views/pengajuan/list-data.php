                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-left" style="font-family: Calibri !important; font-size: 1.2rem;">
                                    <a href="<?= BASE_URL ?>pengajuan/add/<?= $kegiatan ?>" id="btnAdd" class="btn btn-icon btn-success mb-0"><i class="ft-user-plus"></i> &nbsp;Buat Pengajuan Baru</a>
                                </div>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <table class="table table-striped table-responsive" id="dataTablePenghulu" style="font-family: Arial !important;">
                                        <thead>
                                            <tr>
...
<script>
    $(function() {
        ...
        //VIEW PENGHULU
        $('#showDataPengajuan').on('click', '.viewPenghulu', function() {
            var offId = $(this).attr('data');
            $('#modalPenghulu').modal('show');
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += `<tr>
                                    ...
                                    <td scope="col" style="width: 20%">
                                        <a href="${ base_url }pengajuan/dokumen/${data[i].id_pengajuan}" class="btn btn-sm btn-icon btn-info viewPengajuan" style="margin-left:0px;" data-toggle="tooltip" data-placement="bottom" title="Unduh dokumen" data="${data[i].id_pengajuan}"><i class="ft-download"></i></a>
                                        <a href="javascript:;" class="btn btn-sm btn-icon btn-warning editPengajuan" style="margin-left:10px;" data-toggle="tooltip" data-placement="bottom" title="Edit" data="${data[i].id_pengajuan}"><i class="ft-edit-2"></i></a>
                                    ...
                                    <td scope="col" style="width: 5%;">
                                        <div class="badge badge-warning">${ data[i].nama_status }</div>
                                    </td>
                                </tr>`;
                        // html += '<tr>' +

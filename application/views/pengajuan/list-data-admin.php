                        ...
                        if (data.length == jmlTerverif) {
                            ...
                            if (!generated) {
                                ...
                                actionTd = `<td scope="col" ${ rowspan } style="width: 5%; ${ styleTd }">
                                        <a href="javascript:;" class="btn btn-md btn-icon btn-danger cetak-dokumen-verifikasi ${ disabled[0] }" style="margin-left:0px; margin-bottom: 10px; ${ style }" data-toggle="tooltip" data-placement="right" title="${ title[5] }" data="${data[i].id_pengajuan}"><i class="${ icon }"></i></a>
